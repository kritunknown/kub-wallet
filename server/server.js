...
app.get("/flow/hooks", cors(), async(req, res) => {
  ...
  console.log('/flow/hooks==>',{handshake,code})
...
app.post("/flow/authorize", cors(), async(req, res) => {
...
app.get("/flow/authorize", cors(), async(req, res) => {
